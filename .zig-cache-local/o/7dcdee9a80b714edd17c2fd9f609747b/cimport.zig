...
pub const struct_FluxUIApp = opaque {};
pub const FluxUIApp = struct_FluxUIApp;
pub const struct_FluxUIWidget = opaque {};
pub const FluxUIWidget = struct_FluxUIWidget;
pub const FLUXUI_BACKEND_AUTO: c_int = 0;
pub const FLUXUI_BACKEND_VULKAN: c_int = 1;
pub const FLUXUI_BACKEND_DIRECT3D12: c_int = 2;
pub const FLUXUI_BACKEND_DIRECT12: c_int = 2;
pub const FLUXUI_BACKEND_DIRECTX12: c_int = 2;
pub const FLUXUI_BACKEND_METAL: c_int = 3;
pub const FLUXUI_BACKEND_COMPATIBILITY: c_int = 100;
pub const enum_FluxUIRenderBackend = c_uint;
pub const FluxUIRenderBackend = enum_FluxUIRenderBackend;
pub const FluxUIUpdateCallback = ?*const fn (?*FluxUIApp, f32, ?*anyopaque) callconv(.c) void;
pub const FluxUIClickCallback = ?*const fn (?*FluxUIWidget, ?*anyopaque) callconv(.c) void;
pub const struct_FluxUIColor = extern struct {
...
pub const FluxUIColor = struct_FluxUIColor;
pub const struct_FluxUIRect = extern struct {
    x: f32 = @import("std").mem.zeroes(f32),
    y: f32 = @import("std").mem.zeroes(f32),
    w: f32 = @import("std").mem.zeroes(f32),
    h: f32 = @import("std").mem.zeroes(f32),
};
pub const FluxUIRect = struct_FluxUIRect;
pub extern fn fluxui_app_create() ?*FluxUIApp;
pub extern fn fluxui_app_destroy(app: ?*FluxUIApp) void;
pub extern fn fluxui_app_set_backend(app: ?*FluxUIApp, backend: FluxUIRenderBackend) c_int;
pub extern fn fluxui_app_get_backend(app: ?*FluxUIApp) FluxUIRenderBackend;
pub extern fn fluxui_default_backend() FluxUIRenderBackend;
pub extern fn fluxui_backend_name(backend: FluxUIRenderBackend) [*c]const u8;
pub extern fn fluxui_backend_is_compiled(backend: FluxUIRenderBackend) c_int;
pub extern fn fluxui_backend_is_selectable(backend: FluxUIRenderBackend) c_int;
pub extern fn fluxui_app_init(app: ?*FluxUIApp, title: [*c]const u8, width: c_int, height: c_int) c_int;
pub extern fn fluxui_app_shutdown(app: ?*FluxUIApp) void;
pub extern fn fluxui_app_run(app: ?*FluxUIApp) void;
pub extern fn fluxui_app_stop(app: ?*FluxUIApp) void;
pub extern fn fluxui_app_load_stylesheet(app: ?*FluxUIApp, path: [*c]const u8) c_int;
pub extern fn fluxui_app_add_stylesheet(app: ?*FluxUIApp, css: [*c]const u8) void;
pub extern fn fluxui_app_load_font(app: ?*FluxUIApp, path: [*c]const u8, size: f32) c_int;
pub extern fn fluxui_app_load_font_named(app: ?*FluxUIApp, path: [*c]const u8, size: f32, name: [*c]const u8) c_int;
pub extern fn fluxui_app_set_update_callback(app: ?*FluxUIApp, callback: FluxUIUpdateCallback, user_data: ?*anyopaque) void;
pub extern fn fluxui_app_root(app: ?*FluxUIApp) ?*FluxUIWidget;
pub extern fn fluxui_widget_clear_children(widget: ?*FluxUIWidget) void;
pub extern fn fluxui_widget_add_panel(parent: ?*FluxUIWidget, class_name: [*c]const u8) ?*FluxUIWidget;
pub extern fn fluxui_widget_add_text(parent: ?*FluxUIWidget, text: [*c]const u8, class_name: [*c]const u8) ?*FluxUIWidget;
pub extern fn fluxui_widget_add_button(parent: ?*FluxUIWidget, label: [*c]const u8, class_name: [*c]const u8) ?*FluxUIWidget;
pub extern fn fluxui_widget_add_text_input(parent: ?*FluxUIWidget, placeholder: [*c]const u8, class_name: [*c]const u8) ?*FluxUIWidget;
pub extern fn fluxui_widget_add_icon(parent: ?*FluxUIWidget, glyph: [*c]const u8, class_name: [*c]const u8) ?*FluxUIWidget;
pub extern fn fluxui_widget_add_progress_bar(parent: ?*FluxUIWidget, class_name: [*c]const u8, progress: f32) ?*FluxUIWidget;
pub extern fn fluxui_widget_add_stat_card(parent: ?*FluxUIWidget, title: [*c]const u8, value: [*c]const u8, subtitle: [*c]const u8, accent: FluxUIColor) ?*FluxUIWidget;
pub extern fn fluxui_widget_set_id(widget: ?*FluxUIWidget, id: [*c]const u8) void;
pub extern fn fluxui_widget_set_class(widget: ?*FluxUIWidget, class_name: [*c]const u8) void;
pub extern fn fluxui_widget_set_visible(widget: ?*FluxUIWidget, visible: c_int) void;
pub extern fn fluxui_widget_get_bounds(widget: ?*FluxUIWidget) FluxUIRect;
pub extern fn fluxui_widget_set_on_click(widget: ?*FluxUIWidget, callback: FluxUIClickCallback, user_data: ?*anyopaque) void;
pub extern fn fluxui_text_set_content(widget: ?*FluxUIWidget, text: [*c]const u8) void;
pub extern fn fluxui_button_set_label(widget: ?*FluxUIWidget, label: [*c]const u8) void;
pub extern fn fluxui_text_input_set_value(widget: ?*FluxUIWidget, value: [*c]const u8) void;
pub extern fn fluxui_text_input_get_value(widget: ?*FluxUIWidget) [*c]const u8;
pub extern fn fluxui_text_input_set_placeholder(widget: ?*FluxUIWidget, placeholder: [*c]const u8) void;
pub extern fn fluxui_icon_set_glyph(widget: ?*FluxUIWidget, glyph: [*c]const u8) void;
pub extern fn fluxui_progress_bar_set_value(widget: ?*FluxUIWidget, progress: f32) void;
pub extern fn fluxui_progress_bar_set_color(widget: ?*FluxUIWidget, color: FluxUIColor) void;
pub extern fn fluxui_color_rgba(r: f32, g: f32, b: f32, a: f32) FluxUIColor;
pub extern fn fluxui_color_rgb_u8(r: u8, g: u8, b: u8) FluxUIColor;
pub extern fn fluxui_style_width_px(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_height_px(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_min_width_px(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_min_height_px(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_max_width_px(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_max_height_px(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_flex_grow(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_gap_px(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_padding_all_px(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_padding_px(widget: ?*FluxUIWidget, top: f32, right: f32, bottom: f32, left: f32) void;
pub extern fn fluxui_style_margin_all_px(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_margin_px(widget: ?*FluxUIWidget, top: f32, right: f32, bottom: f32, left: f32) void;
pub extern fn fluxui_style_border_radius_px(widget: ?*FluxUIWidget, value: f32) void;
pub extern fn fluxui_style_background_color(widget: ?*FluxUIWidget, color: FluxUIColor) void;
pub extern fn fluxui_style_text_color(widget: ?*FluxUIWidget, color: FluxUIColor) void;
...
// C:\zig-x86_64-windows-0.15.2\lib\include/stdint.h:291:9
pub const __intptr_t_defined = "";
pub const _INTPTR_T = "";
pub const _UINTPTR_T = "";
pub const __int_c_join = @compileError("unable to translate C expr: unexpected token '##'");
// C:\zig-x86_64-windows-0.15.2\lib\include/stdint.h:328:9
...
// C:\zig-x86_64-windows-0.15.2\lib\include/stdint.h:330:9
