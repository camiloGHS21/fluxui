    ...
    return Div({
        ...
        Div({
            Div({
                ...
                ToggleRow("Block mode","Apply blocking actions when confidence exceeds policy threshold.",blockMode()),
            ...
            Div({
                ...
                Button("Pause Cloud Sync").className("btn btn-secondary btn-full")
